...
public class ModParticleRegister {
    ...
    public static final ParticleData DIY_PARTICLE_DATA = new ParticleData(Vec3d.ZERO,new Color(0f,0f,0f,0),5000, SPARKLE_PARTICLE,false,0.3f, ModParticleSheet.DEFAULT_PARTICLE_SHEET);
    ...
    private static void registerParticleFactory(){
        registerParticleFactoryEz(SPARKLE_PARTICLE);
